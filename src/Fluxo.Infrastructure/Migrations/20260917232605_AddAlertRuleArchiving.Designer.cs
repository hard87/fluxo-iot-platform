...
namespace Fluxo.Infrastructure.Migrations
{
    ...
    [Migration("20260917232605_AddAlertRuleArchiving")]
    partial class AddAlertRuleArchiving
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fluxo.Domain.Alerts.AlertRuleRevision", b =>
                {
                    ...
                    b.ToTable("alert_rule_revisions", null, t =>
                        {
                            t.HasCheckConstraint("CK_alert_revision_archive", "\"ArchivedAtUtc\" IS NULL OR NOT \"Enabled\"");
            ...
            modelBuilder.Entity("Fluxo.Domain.Alerts.NotificationSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkspaceId", "RuleId", "MemberId", "Channel")
                        .IsUnique();

                    b.ToTable("alert_notification_subscriptions", null, t =>
                        {
                            t.HasCheckConstraint("CK_alert_notification_subscription_channel", "\"Channel\" IN ('Portal')");
                        });
                });

            modelBuilder.Entity("Fluxo.Domain.Alerts.PortalNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkspaceId", "TransitionId", "RecipientUserId")
                        .IsUnique();
